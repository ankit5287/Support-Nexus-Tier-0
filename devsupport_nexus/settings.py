"""
Django settings for devsupport_nexus project.
...
SECRET_KEY = 'django-insecure-uo+#gv1v0)r%5c#m$s3&h@^n$aq=088$8o98iz+z=6=_w7vf2^'
...
ROOT_URLCONF = 'devsupport_nexus.urls'
...
WSGI_APPLICATION = 'devsupport_nexus.wsgi.application'
...
if os.environ.get('VERCEL'):
    ...
    # On Vercel startup, if the DB doesn't exist in /tmp, copy the initial one
    import shutil
